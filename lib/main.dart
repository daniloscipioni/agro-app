...
void main() {
  ...
  // _dao.saveModel(Model(4,10,'1580'));
  // _dao.saveModel(Model(5,1,'BT 150'));
  // _dao.saveModel(Model(6,1,'BH 205'));
  // _dao.saveModel(Model(7,1,'BT 210'));
  // _dao.saveModel(Model(8,4,'8670'));
  // _dao.saveModel(Model(9,1,'S 353'));
  // _dao.saveModel(Model(10,7,'1050 Vario'));
  // _dao.saveModel(Model(11,2,'6300'));
  // _dao.saveModel(Model(12,2,'7815'));
  // _dao.saveModel(Model(13,2,'8335 R'));
  // _dao.saveModel(Model(14,11,'Landforce 120'));
  // _dao.saveModel(Model(15,1,'BC 7500'));
  // _dao.saveModel(Model(16,1,'BC 8800'));
  // _dao.saveModel(Model(17,4,'MF 9895'));
  // _dao.saveModel(Model(18,2,'STS 9750'));
  // _dao.saveModel(Model(19,2,'S680'));
  // _dao.saveModel(Model(20,2,'STS 9770'));
  // _dao.saveModel(Model(21,1,'BS3020H'));
  // _dao.saveModel(Model(22,2,'4730'));
  // _dao.saveModel(Model(23,8,'Hercules'));
